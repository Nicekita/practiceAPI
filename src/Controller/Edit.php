...
class Edit
{
    function sql($year,$semestr,$header,$connectionstring) {
        ...
        if (isset($_POST['eventtypename'])&&isset($_POST['divisionname'])&&isset($_POST['eventid'])&&isset($_POST['eventname'])&&isset($_POST['eventplace'])&&isset($_POST['eventdate'])&&isset($_POST['teacher'])&&isset($_POST['usermax'])&&isset($_POST['addinfo'])) {
            ...
            $query = "UPDATE events set eventname='" . $_POST["eventname"] . "', eventplace='" . $_POST["eventplace"] . "',eventdate='" . $_POST["eventdate"] . "',teacher='" . $_POST["teacher"] . "',usermax=" . $_POST["usermax"] . ",eventtypeid='" . $eventtypeid . "',addinfo='" . $_POST["addinfo"] . "',divisionid='" . $divisionid . "',eventyear=".$year.",eventsemestr=".$semestr." where eventid='" . $_POST["eventid"] . "'";
